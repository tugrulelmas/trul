namespace Trul.Domain.Core.Specification
{
    using System;
    using System.Linq;
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="Trul.Domain.Core.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="Trul.Domain.Core.Specification.ISpecification{TEntity}"/></returns>
